    ...
    <section class="lots">
        ...
        $adds = [
            [
                ...
                "price" => "10999",
                "url-cat" => "img/lot-1.jpg"
            ],
            [
                "name" => "DC Ply Mens 2016/2017 Snowboard",
                "category" => "Доски и лыжи",
                "price" => "159999",
                "url-cat" => "img/lot-2.jpg"
            ],
            [
                "name" => "Крепления Union Contact Pro 2015 года размер L/XL",
                "category" => "Крепления",
                "price" => "8000",
                "url-cat" => "img/lot-3.jpg"
            ],
            [
                "name" => "Ботинки для сноуборда DC Mutiny Charocal",
                "category" => "Ботинки",
                "price" => "10999",
                "url-cat" => "img/lot-4.jpg"
            ],
            [
                "name" => "Куртка для сноуборда DC Mutiny Charocal",
                "category" => "Одежда",
                "price" => "7500",
                "url-cat" => "img/lot-5.jpg"
            ],
            [
                "name" => "Маска Oakley Canopy",
                "category" => "Разное",
                "price" => "5400",
                "url-cat" => "img/lot-6.jpg"
            ]
        ]
        ;?>
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$val["url-cat"]; ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
